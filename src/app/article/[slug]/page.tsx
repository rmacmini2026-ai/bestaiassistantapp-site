      ...
      <article className="mx-auto max-w-4xl">
        ...
        <div className="mt-14 rounded-[2rem] border border-black/10 bg-white/75 p-8 shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
          ...
          <div className="mt-6 overflow-hidden rounded-[1.5rem] border border-black/8 bg-[#f7f4ee] p-2">
            <iframe src="https://subscribe-forms.beehiiv.com/bb32401e-c7a5-4631-bc05-ce32449ecf21" className="beehiiv-embed h-[320px] w-full bg-transparent" frameBorder="0" scrolling="no" title="Beehiiv subscribe form" />
          </div>
        </div>
      </article>
    </main>
